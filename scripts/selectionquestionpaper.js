//QUESTION PAPER PAGE SELECTION

let courseVal = document.getElementById('courseSelectqp');
let yearVal = document.getElementById('yearSelectqp');
let streamVal = document.getElementById('streamSelectqp');
let subjectVal = document.getElementById('subjectSelectqp');
let chapterVal = document.getElementById('chapterSelectqp');
