...
let courseVal = document.getElementById('courseSelectc');
let yearVal = document.getElementById('yearSelectc');
let streamVal = document.getElementById('streamSelectc');
let subjectVal = document.getElementById('subjectSelectc');
let chapterVal = document.getElementById('chapterSelectc');
