            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    ...
                    <div class="section-title text-center ">
                            <h3 class="top-c-sep">CLASS NOTES</h3>
                        </div>
                        <form action="classnote.php" method="POST" class="career-form mb-60">
                        ...
                        <div class="filter-result">
                            ...
                            <?php
                                ...
                                if(isset($_POST['classnotefilter'])){
                                    ...
                                    $sql = "SELECT * FROM `classnote` WHERE `course`='$courseSelectFilter' AND `year`='$yearSelectFilter' AND `stream`='$streamSelectFilter' AND `subject`='$subjectSelectFilter'";
                                    $flag=true;
                                    }
                                    else if($streamSelectFilter != "error" && $subjectSelectFilter == "error"){
                                        $sql = "SELECT * FROM `classnote` WHERE `course`='$courseSelectFilter' AND `year`='$yearSelectFilter' AND `stream`='$streamSelectFilter'";
                                        $flag=true;
                                    }
                                    else if($yearSelectFilter != "error" && $streamSelectFilter == "error"){
                                        $sql = "SELECT * FROM `classnote` WHERE `course`='$courseSelectFilter' AND `year`='$yearSelectFilter'";
                                        $flag=true;
                                    }
                                    else if($courseSelectFilter != "error" && $yearSelectFilter == "error"){
                                        $sql = "SELECT * FROM `classnote` WHERE `course`='$courseSelectFilter'";
                                        $flag=true;
                                    }
                                    else{
                                    ...
                                    if($flag){
                                        ...
                                        while($row=mysqli_fetch_assoc($result)){
                                            ...
                                            <div class="job-right my-4 flex-shrink-0">
                                                <a href="../DATABASE/NOTES/'.$row['pdf'].'" class="btn d-block w-100 d-sm-inline-block btn-dark">DOWNLOAD</a>
                                            </div>
                                        </div>';
                                        $count = $count + 1;
                                        }
