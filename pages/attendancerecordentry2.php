            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="career-search mb-60">
                        ...
                        <!-- Enter data -->
                        <form action="attendancerecordentry2.php" method="POST" class="career-form mb-60" enctype="multipart/form-data">
                        ...
                        <div class="filter-result" style="margin-top: 10px">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $sql = "INSERT INTO `studentlogin` (`enrollment`, `registration`, `name`, `present`) VALUES ('".$enrollment."', '".$registration."', '".$name."', '".$present."');";
