...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/questionPaperStyle.css">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark"> <!-- add fixed-top to keep nav bar in place -->
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    ...
                    <div class="section-title text-center ">
                            <h3 class="top-c-sep">QUESTION PAPERS</h3>
                        </div>
                        <form action="questionpaper.php" method="POST" class="career-form mb-60">
                            <div class="row insidecard">
                                
                                <!-- Filters -->
                                <div class="col-md-6 col-lg-2 my-3">
                                    <div class="select-container">
                                        <select class="custom-select" name="courseSelectqp" id="courseSelectqp">
                                ...
                                <div class="col-md-6 col-lg-2 my-3">
                                    <div class="select-container">
                                        <select class="custom-select" name="yearSelectqp" id="yearSelectqp">
                                ...
                                <div class="col-md-6 col-lg-2 my-3">
                                    <div class="select-container">
                                        <select class="custom-select" name="streamSelectqp" id="streamSelectqp">
                                ...
                                <div class="col-md-6 col-lg-3 my-3">
                                    <div class="select-container">
                                        <select class="custom-select" name="subjectSelectqp" id="subjectSelectqp">
                                        <option selected="" value="error">Subject</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-3 my-3">
                                    <button name="questionpaperfilter" class="btn btn-lg btn-block btn-light btn-custom" id="contact-submit">
                                        Search
                                    </button>
                                </div>
                                <!-- Filter end -->
                        ...
                        <div class="filter-result">
                            <?php
                                ...
                                if(isset($_POST['questionpaperfilter'])){
                                    $courseSelectFilter = $_POST['courseSelectqp'];
                                    $yearSelectFilter = $_POST['yearSelectqp'];
                                    $streamSelectFilter = $_POST['streamSelectqp'];
                                    $subjectSelectFilter = $_POST['subjectSelectqp'];

                                    $flag=true;

                                    if($subjectSelectFilter != "error"){
                                    $sql = "SELECT * FROM `questionpaper` WHERE `course`='$courseSelectFilter' AND `year`='$yearSelectFilter' AND `stream`='$streamSelectFilter' AND `subject`='$subjectSelectFilter'";
                                    $flag=true;
                                    }
                                    else if($streamSelectFilter != "error" && $subjectSelectFilter == "error"){
                                        $sql = "SELECT * FROM `questionpaper` WHERE `course`='$courseSelectFilter' AND `year`='$yearSelectFilter' AND `stream`='$streamSelectFilter'";
                                        $flag=true;
                                    }
                                    else if($yearSelectFilter != "error" && $streamSelectFilter == "error"){
                                        $sql = "SELECT * FROM `questionpaper` WHERE `course`='$courseSelectFilter' AND `year`='$yearSelectFilter'";
                                        $flag=true;
                                    }
                                    else if($courseSelectFilter != "error" && $yearSelectFilter == "error"){
                                        $sql = "SELECT * FROM `questionpaper` WHERE `course`='$courseSelectFilter'";
                                        $flag=true;
                                    }
                                    else{
                                        ...
                                        while($row=mysqli_fetch_assoc($result)){
                                            ...
                                            <div class="job-left my-4 d-md-flex align-items-center flex-wrap">
                                                ...
                                                <div class="job-content">
                                                    <h5 class="text-center text-md-left">'.$row['name'].'</h5>
                                            ...
                                            <div class="job-right my-4 flex-shrink-0">
                                                <a href="../DATABASE/PAPER/'.$row['pdf'].'" class="btn d-block w-100 d-sm-inline-block btn-dark">DOWNLOAD</a>
                                            </div>
                                        </div>';
                                        $count = $count + 1;
                                        }
    ...
    <script src="../scripts/selectionquestionpaper.js"></script>
