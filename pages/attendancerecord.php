        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <form action="attendancedataview.php" method="POST">
                  <div class="form-group">
                    <label for="email" class="sr-only">Enrollment number</label>
                    <input type="text" name="enrollment" id="enrollment" class="form-control" placeholder="Enrollment number">
                  </div>
                  <div class="form-group mb-4">
                    <label for="password" class="sr-only">Registration number</label>
                    <input type="text" name="registration" id="registration" class="form-control" placeholder="Registration number">
                  </div>
                  <button name="login" id="login" class="btn btn-block login-btn mb-4">Login</button>
              </form>
            </div>
          </div>
        </div>
